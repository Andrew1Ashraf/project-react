...
function SingleBlog() {
  return (
    <section className="single-blog-page">
      {/* <nav>
        <img src="/assets/single-blog/foodieland..svg" alt="logo" />
        ...
        <div className="icons">
          ...
          <i className="fa-brands fa-x-twitter" style={{ fontSize: "22px" }}></i>
        ...
        <div className="card-container">
          <div className="card">
            <div className="card-img-wrapper">
              <img className="badge" src="/assets/single-blog/Group 852.svg" alt="" />
              <img
                className="main-img"
